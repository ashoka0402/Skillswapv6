...
export default function RatingModal({ isOpen, onClose, request, onSubmit }: RatingModalProps) {
      ...
      <DialogContent className="sm:max-w-md bg-white/95 backdrop-blur-md border-white/20">
        ...
        <div className="space-y-6">
          <div className="text-center">
            <p className="text-gray-600 mb-6">How was your skill swap experience?</p>
          ...
          <div className="space-y-2">
            <label className="block text-sm font-semibold text-gray-700">Feedback (Optional)</label>
            <Textarea
